...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		...
		String height = JOptionPane.showInputDialog(null, "What's your height in inches?");
		...
		// Uncomment the line below...
			if( heightToRide > 42 ) { 
				...
				JOptionPane.showMessageDialog(null, "You can go on the ride with someone else!");
